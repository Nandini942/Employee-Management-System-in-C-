                            ...
                            if (cmb_gender.Text == "")
                            {
                                ...
                                if (cmb_position.Text == "")
                                {
                                    ...
                                    if (txt_phoneno.Text == "")
                                    {
                                        ...
                                        {
                                            SqlConnection con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\hp\documents\visual studio 2010\Projects\Employee Management System in Csharp\Employee Management System in Csharp\db_employee.mdf;Integrated Security=True;User Instance=True");
